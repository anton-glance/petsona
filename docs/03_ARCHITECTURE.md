...
|---|---|---|---|
| Apple Developer Account | iOS bundle ID `com.antonglance.mypet`, App Store Connect, TestFlight | R0 | R0-M2 |
| Google Play Developer Account | Android app `com.antonglance.mypet`, Play Internal Testing | R0 | R0-M2 |

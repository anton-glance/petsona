...
- [ ] Apple Developer: register App ID `com.antonglance.petsona`
- [ ] App Store Connect: create the iOS app entry with bundle ID `com.antonglance.petsona`
- [ ] Google Play Console: create the Android app entry with application ID `com.antonglance.petsona` (placeholder icon and screenshots are fine)
